        ...
        <div className="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
          <div className="flex flex-col items-center w-full gap-6 xl:flex-row">
            <div className="w-20 h-20 overflow-hidden border border-gray-200 rounded-full dark:border-gray-800">
              <img
                src={profile?.profileAvatar || "/images/user/owner.jpg"}
                alt="user"
            ...
            <div className="order-3 xl:order-2">
              ...
              <div className="flex flex-col items-center gap-1 text-center xl:flex-row xl:gap-3 xl:text-left">
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  {profile?.adminType || "Administrator"}
                </p>
            ...
            <div className="custom-scrollbar h-[450px] overflow-y-auto px-2 pb-3">
              <div>
                ...
                <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                  ...
                  <div>
                    <Label>X.com</Label>
                    <Input type="text" defaultValue={profile?.socialLinks?.twitter || ""} />
                  </div>
                  ...
                  <div>
                    ...
                    <Input type="text" defaultValue={profile?.socialLinks?.instagram || ""} />
                  </div>
                </div>
              </div>
              <div className="mt-7">
                ...
                <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                  ...
                  <div className="col-span-2 lg:col-span-1">
                    ...
                    <Input type="text" defaultValue={profile?.userEmail || ""} />
                  </div>
