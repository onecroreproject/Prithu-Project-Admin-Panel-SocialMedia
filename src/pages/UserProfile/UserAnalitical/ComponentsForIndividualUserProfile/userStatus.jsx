    ...
    <div>
      ...
      <div className="space-y-4">
        <div className="grid grid-cols-2 gap-3">
          <div className="bg-linear-to-br from-blue-50 to-white p-3 rounded-xl border border-blue-100">
        ...
        <div className="p-3 bg-linear-to-br from-gray-50 to-white rounded-xl border border-gray-200">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm font-medium text-gray-900">Account Level</span>
            <span className="px-2 py-1 bg-linear-to-r from-yellow-100 to-yellow-50 text-yellow-700 rounded-full text-xs font-medium">
        ...
        <div className="p-3 bg-linear-to-br from-purple-50 to-white rounded-xl border border-purple-100">
