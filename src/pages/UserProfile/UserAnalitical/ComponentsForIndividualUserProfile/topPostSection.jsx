    ...
    <div>
      <div className="border-b border-gray-200 px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <span className="px-3 py-1 bg-linear-to-r from-blue-100 to-blue-50 text-blue-600 rounded-full text-sm font-medium">
      ...
      <div className="p-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {topPosts.map((post, index) => (
            <div key={post._id} className="bg-linear-to-br from-gray-50 to-white rounded-2xl border border-gray-200 p-5 hover:shadow-lg transition-all duration-300">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2">
                  <div className={`w-8 h-8 rounded-lg flex items-center justify-center text-white font-bold ${
                    index === 0 ? 'bg-linear-to-r from-yellow-500 to-orange-500' :
              ...
              <div className="mb-4 rounded-xl overflow-hidden border border-gray-200">
                {post.type === 'image' ? (
                  ...
                  <div className="w-full h-48 bg-linear-to-br from-purple-500 to-pink-500 flex items-center justify-center">
                    <svg className="w-12 h-12 text-white" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M8 5v14l11-7z" />
                    </svg>
                  </div>
                ) : (
                  <div className="w-full h-48 bg-linear-to-br from-blue-500 to-cyan-500 flex items-center justify-center">
              ...
              <div className="space-y-3">
                ...
                {/* Total Score */}
                <div className="mt-4 p-3 bg-linear-to-r from-gray-50 to-gray-100 rounded-xl">
                  <div className="flex items-center justify-between">
                    <span className="text-sm font-medium text-gray-700">Engagement Score</span>
                    <span className="px-3 py-1 bg-linear-to-r from-blue-500 to-blue-600 text-white rounded-full text-sm font-bold">
                      {post.score}
                    </span>
                  </div>
                </div>
