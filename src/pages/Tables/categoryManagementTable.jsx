...
export default function CategoryManagement() {
  ...
  const TagChips = ({ tags, onRemove }) => (
    tags.length > 0 && (
      <div className="flex flex-wrap gap-1.5 mb-2">
        {tags.map((tag) => (
          <span key={tag} className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-blue-100 dark:bg-blue-900/40 text-blue-800 dark:text-blue-200 text-xs font-semibold border border-blue-200 dark:border-blue-800/60">
            <Tag className="w-3 h-3" />
            {tag}
            <button type="button" onClick={() => onRemove(tag)} className="ml-0.5 text-blue-400 hover:text-red-500 cursor-pointer">
              <X className="w-3 h-3" />
            </button>
          </span>
        ))}
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl w-full max-w-md p-6 shadow-2xl relative">
            <button
              ...
              className="absolute top-4 right-4 p-1.5 text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors cursor-pointer"
            >
              <X className="w-5 h-5" />
            </button>
            ...
            <div className="flex items-center gap-3 mb-5">
              ...
              <div>
                <h3 className="text-lg font-extrabold text-gray-900 dark:text-gray-100">Add New Category</h3>
                <p className="text-xs text-gray-500">Create a category with optional subcategories.</p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border border-gray-200 dark:border-gray-700 rounded-xl text-sm bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all"
                />
              </div>
              ...
              <div>
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    type="button"
                    onClick={addAddTag}
                    className="px-3 py-2.5 bg-gray-100 dark:bg-gray-700 rounded-xl border border-gray-200 dark:border-gray-600 hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors cursor-pointer"
                  >
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl w-full max-w-md p-6 shadow-2xl relative">
            ...
            <div className="flex items-center gap-3 mb-5">
              ...
              <div>
                <h3 className="text-lg font-extrabold text-gray-900 dark:text-gray-100">Edit Category</h3>
                <p className="text-xs text-gray-500">Editing: {editModal.categoriesName}</p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border border-gray-200 dark:border-gray-700 rounded-xl text-sm bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 transition-all"
                />
              </div>
              <div>
                <label className="block text-xs font-semibold text-gray-700 dark:text-gray-300 mb-1.5">
                ...
                <div className="flex gap-2">
                  ...
                  />
                  <button type="button" onClick={addEditTag} className="px-3 py-2.5 bg-gray-100 dark:bg-gray-700 rounded-xl border border-gray-200 dark:border-gray-600 hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors cursor-pointer">
                    <Plus className="w-4 h-4 text-gray-600 dark:text-gray-300" />
                  </button>
                </div>
              </div>
      ...
      {viewingCat && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl w-full max-w-sm p-6 shadow-2xl relative flex flex-col max-h-[80vh]">
            <button
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="text-base font-extrabold text-gray-900 dark:text-gray-100">{viewingCat.categoriesName}</h3>
                <p className="text-xs text-gray-500">{viewingCat.subcategories?.length || 0} subcategories</p>
              </div>
            </div>

            <div className="space-y-2 overflow-y-auto flex-1 pr-1">
              {(viewingCat.subcategories || []).map((sub) => (
                <div key={sub} className="flex items-center justify-between p-3 rounded-xl border border-gray-100 dark:border-gray-800 bg-gray-50/80 dark:bg-gray-800/50 hover:bg-white dark:hover:bg-gray-800 transition-colors">
                  ...
                  <button
                    ...
                    className="p-1.5 text-gray-300 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-900/30 rounded-lg transition-colors cursor-pointer"
                  >
                    <Trash className="w-3.5 h-3.5" />
                  </button>
                </div>
